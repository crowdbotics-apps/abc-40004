"""
Django settings for abc_40004 project.
...
WSGI_APPLICATION = 'abc_40004.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abc_40004 API",
    "DESCRIPTION": "API documentation for abc_40004 App",
    "VERSION": "v1",
}
